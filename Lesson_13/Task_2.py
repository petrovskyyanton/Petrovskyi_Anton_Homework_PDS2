...
def time_of_sorting(nums, number_of_iteration):
    cur_time = time.time()
    for i in range(number_of_iteration):
        heap_sort(nums)
    return (time.time() - cur_time) / number_of_iteration
...
t1 = time_of_sorting(copy_my_list_1, iteration_number)
t2 = time_of_sorting(copy_my_list_2, iteration_number)
t3 = time_of_sorting(copy_my_list_3, iteration_number)
